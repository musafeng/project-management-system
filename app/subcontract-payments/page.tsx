...
export default function SubcontractPaymentsPage() {
  ...
  const handleReset = () => {
    ...
    setMonth(null)
    loadPayments(undefined, undefined, null)
  }
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        <Space size="small">
          ...
          <Popconfirm title="删除分包付款" description="确定删除该分包付款记录吗？" onConfirm={() => handleDelete(record.id)} okText="确定" cancelText="取消">
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Button
                  onClick={() => { window.location.href = '/data-exports?resourceType=subcontract-payments' }}
